...
func PaymentId(paymentId string) slog.Attr { return slog.String("payment_id", paymentId) }

func ExternalId(externalId string) slog.Attr { return slog.String("external_id", externalId) }
