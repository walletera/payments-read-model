# Payments Read Model
[![Go](https://github.com/walletera/payments-read-model/actions/workflows/release.yml/badge.svg)](https://github.com/walletera/payments-read-model/actions/workflows/release.yml)
